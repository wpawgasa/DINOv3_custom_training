...
class TestTrainingPerformance:
    ...
    def test_training_step_performance(self, experiment_config, sample_dataset_dir):
        ...
        with pytest.mock.patch('transformers.AutoModel.from_pretrained') as mock_pretrained:
            ...
            print(f"Average training step: {avg_step_time*1000:.1f} ± {std_step_time*1000:.1f} ms")
    ...
    def test_gradient_computation_performance(self, sample_model):
        ...
        batch_size = 8
        test_input = torch.randn(batch_size, 3, 224, 224, device=device)
        test_targets = torch.randint(0, sample_model.num_classes, (batch_size,), device=device)
