...
from data.augmentations import create_transforms, DomainAugmentations
...
class TestImagePreprocessor:
    ...
    def test_quality_filtering(self):
        ...
        preprocessor = ImagePreprocessor(
            target_size=(224, 224),
            quality_threshold=80  # High threshold
        )
...
class TestDataLoader:
    ...
    def test_dataloader_iteration(self, sample_dataset_dir):
        ...
        for batch_images, batch_labels in dataloader:
            ...
            assert batch_images.min() >= -3.0  # Approximate lower bound after normalization
            assert batch_images.max() <= 3.0   # Approximate upper bound after normalization
