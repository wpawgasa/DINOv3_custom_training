...
from utils.device import setup_distributed_training, cleanup_distributed, get_device_manager
...
def setup_distributed_training_env(args: argparse.Namespace) -> tuple:
    ...
    if args.distributed or "LOCAL_RANK" in os.environ:
        try:
            ...
            print(f"Distributed training: rank {rank}, local_rank {local_rank}, world_size {world_size}")
